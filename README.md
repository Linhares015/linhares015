...
> **"Construo arquiteturas de dados que transformam operações em decisões."**

🚀 Especialista em Dados & IA na **BBM Logística**  
⚡ Migrei toda a infraestrutura **AWS → Databricks** (↓ custo, ↑ velocidade)  
🤖 Desenvolvo **Agentes de IA autônomos** com LLMs aplicados a negócios  
📊 **100+ pipelines em produção** | **100+ pessoas formadas** em Data Driven  
🌱 Apaixonado por **Open Source** e por democratizar o conhecimento em dados  
📍 Curitiba, Brasil
...
| | | |
|:---:|:---:|:---:|
| 🔧 **100+** Pipelines em produção | 🎓 **100+** Pessoas formadas | ⏱️ **~5** Anos em dados |
| 🏅 **8** Certificações técnicas | 👥 **3.7K+** Seguidores LinkedIn | 🌐 Open Source contributor |
...
**🏆 Athena Stack Infra** — `Open Source` `Educacional` `3 Níveis de Maturidade`  
Evolução completa de uma stack de dados: do Excel ao Databricks. Cobre ingestão, transformação, orquestração, monitoramento e governança.  
`Docker` · `PostgreSQL` · `Airflow` · `Airbyte` · `DBT` · `Metabase` · `Grafana` · `Prometheus`

**🎓 Curso SQL** — `Gratuito` `Comunidade` `Atualizado continuamente`  
Curso completo de SQL para analistas e engenheiros de dados. Conteúdo prático e direto ao ponto.
...
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=Linhares015&theme=tokyo-night&hide_border=true&area=true)](https://github.com/Linhares015)
...
[![Trophies](https://github-profile-trophy.vercel.app/?username=Linhares015&theme=tokyonight&no-frame=true&row=1&column=6)](https://github.com/Linhares015)
...
🔭 **Trabalhando em:** Agentes de IA autônomos para processos empresariais  
🌱 **Estudando:** LLMs, MLOps e Databricks AI/BI  
👯 **Colaborando em:** Projetos open source de dados  
💬 **Pergunte sobre:** Databricks, Arquitetura de Dados, Engenharia de Dados, Agentes de IA  
📫 **Contato:** [linkedin.com/in/tiago-linhares](https://www.linkedin.com/in/tiago-linhares/)  
⚡ **Curiosidade:** Comecei em finanças e migrei para dados — a melhor decisão da minha carreira
